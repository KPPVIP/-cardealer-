...
if GetCurrentResourceName() == 'esx_chatarrero' then
  ...
  print("\n".. " Correctement chargé. Édité par WackySpring et Ikarus ")
	...
	math.randomseed(GetGameTimer())
		...
		TriggerClientEvent('esx:showNotification', source, ('Vous avez déjà toutes les portes.'))
	else
   ...
   xPlayer.addInventoryItem('bateria',math.random(0, 1))
		...
		TriggerClientEvent('esx:showNotification', source, ('Vous ne pouvez pas transporter plus de pneus'))
	else
