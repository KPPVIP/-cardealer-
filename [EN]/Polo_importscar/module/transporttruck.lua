...
function missionTransportTruck(vehicule, start, headingStart, stop, prix, LongText, id)
    ShowAdvancedNotification("MISSION", "VEHICLE TRANSPORT Truck", LongText, "CHAR_MOLLY", 8)
